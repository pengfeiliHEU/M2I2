...
def create_dataset(dataset, config):
    ...
    if dataset == 'med_pretrain':
        dataset = med_pretrain_dataset(config['train_file'], pretrain_transform, image_root=config['image_root'])
        return dataset

    # vqa_rad
    elif dataset == 'rad':
        train_dataset = rad_dataset(config['train_file'], train_transform, config['vqa_root'], split='train')
        test_dataset = rad_dataset(config['test_file'], test_transform, config['vqa_root'], split='test',
